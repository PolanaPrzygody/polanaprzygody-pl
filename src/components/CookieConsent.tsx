            ...
            <div className="flex flex-col md:flex-row items-start md:items-center gap-4">
              ...
              <div className="flex gap-3 w-full md:w-auto">
                <button
                  ...
                  className="flex-1 md:flex-none px-4 py-2 text-sm font-medium text-polana-straw/80 hover:text-polana-straw border border-polana-straw/30 hover:border-polana-straw/50 rounded-lg transition-colors"
                >
                  Odrzuć
                </button>
                <button
